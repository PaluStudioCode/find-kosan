...
const submit = () => {
    if (editingUser.value) {
        form.put(route('superadmin.users.update', editingUser.value.id), {
            onSuccess: () => {
...
const executeDelete = () => {
    ...
    router.delete(route('superadmin.users.destroy', userToDelete.value.id), {
        onSuccess: () => {
                        ...
                        <div class="flex items-center gap-2">
                            <Select v-model="roleFilter" @update:modelValue="doSearch">
                                ...
                                <SelectContent class="dark:bg-slate-800 dark:border-slate-700">
                                    ...
                                    <SelectItem value="user" class="dark:text-slate-200 dark:focus:bg-slate-700">Penyewa</SelectItem>
                                    <SelectItem value="admin" class="dark:text-slate-200 dark:focus:bg-slate-700">Pemilik Kos</SelectItem>
