            ...
            <Dialog v-model:open="isDialogOpen">
                ...
                <DialogContent class="sm:max-w-[425px] dark:bg-slate-900 dark:border-slate-800">
                    ...
                    <form class="space-y-4 mt-2" @submit.prevent="submit">
                        <div>
                            <Label for="amount" class="text-gray-700 dark:text-slate-300 font-medium">Nominal</Label>
                            <Input id="amount" v-model="form.amount" class="mt-1.5" type="number" min="1" placeholder="Contoh: 500000" />
