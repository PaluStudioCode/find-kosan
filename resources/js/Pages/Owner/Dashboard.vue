        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <Card class="relative overflow-hidden border-0 shadow-lg bg-gradient-to-br from-slate-900 to-slate-800 text-white transform hover:-translate-y-1 transition-all duration-300">
                ...
                <CardContent class="relative z-10 border-0">
                    ...
                    <Link :href="route('owner.wallet.index')" class="inline-flex items-center gap-1 text-xs font-semibold text-indigo-300 hover:text-white mt-3 transition-colors bg-white/10 px-3 py-1.5 rounded-full">
            ...
            <div class="space-y-6">
                ...
                <Card class="shadow-sm border border-slate-100 dark:border-0 dark:bg-slate-900">
                    <CardHeader class="pb-3 flex flex-row items-center justify-between border-b border-slate-100 dark:border-slate-800">
                        ...
                        <Link :href="route('owner.wallet.index')" class="text-xs font-semibold text-emerald-600 dark:text-emerald-400 hover:text-emerald-700 dark:hover:text-emerald-300 flex items-center mt-0">
            ...
            <div class="space-y-6">
                    ...
                    <CardContent class="pt-4 border-0">
                        <div v-if="vacantRooms.length > 0" class="space-y-3">
                            <div v-for="room in vacantRooms" :key="room.id" class="group flex items-center justify-between p-3 bg-white dark:bg-slate-800/50 border border-blue-100 dark:border-slate-700/50 shadow-sm rounded-xl hover:border-blue-300 dark:hover:border-blue-500/50 transition-colors">
                                ...
                                <Link :href="route('owner.kos.show', { kos: room.boarding_house_id, tab: 'rooms', edit_room: room.id })" class="text-xs font-semibold text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-500/10 hover:bg-blue-600 dark:hover:bg-blue-500 hover:text-white px-3 py-1.5 rounded-full transition-colors">
                                    Promosikan
                                </Link>
                            </div>
                        </div>
                ...
                <Card class="shadow-sm border border-slate-100 dark:border-0 dark:bg-slate-900">
                    <CardHeader class="pb-3 flex flex-row items-center justify-between border-b border-slate-100 dark:border-slate-800">
                        ...
                        <Link :href="route('owner.reviews.index')" class="text-xs font-semibold text-teal-600 dark:text-teal-400 hover:text-teal-700 dark:hover:text-teal-300 flex items-center mt-0">
                            Semua <ArrowRight class="w-3 h-3 ml-1" />
                        </Link>
                    </CardHeader>
                    <CardContent class="pt-4 border-0">
