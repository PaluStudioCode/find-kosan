                        ...
                        <TableBody>
                            <TableRow v-for="report in reports.data" :key="report.id" class="dark:border-slate-800 dark:hover:bg-slate-800/30 transition-colors">
                                ...
                                <TableCell>
                                    ...
                                    <div class="text-xs text-gray-500 dark:text-slate-500">Pemilik: {{ report.boarding_house?.admin?.name || 'Tidak Ada Data' }}</div>
                                </TableCell>
                                <TableCell>
                                ...
                                <TableCell class="text-right">
                                    <Link :href="route('superadmin.reports.show', report.id)">
