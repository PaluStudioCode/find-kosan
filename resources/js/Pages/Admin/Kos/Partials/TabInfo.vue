            ...
            <form @submit.prevent="submit" class="space-y-8">
                ...
                <div class="space-y-4">
                    ...
                    <div class="space-y-2">
                        ...
                        <p class="text-xs text-gray-500 dark:text-slate-400 mt-1">💡 Tip: Sebutkan rumah sakit, kampus, stasiun, atau tempat terkenal terdekat. Bot WhatsApp kami menggunakan info ini untuk membantu penyewa mencari kos berdasarkan lokasi.</p>
