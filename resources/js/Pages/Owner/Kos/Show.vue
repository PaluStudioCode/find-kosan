...
<template>
    <AppLayout>
        ...
        <div class="mb-6 flex flex-col md:flex-row md:justify-between md:items-end gap-4">
            <div>
                <Link :href="route('owner.kos.index')" class="text-sm text-gray-500 dark:text-slate-400 hover:text-gray-900 dark:hover:text-white flex items-center mb-2 inline-flex transition-colors">
