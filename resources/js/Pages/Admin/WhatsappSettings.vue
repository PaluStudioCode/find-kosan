...
async function pollStatus() {
    try {
        ...
        if (isConnecting.value) {
            const qrResponse = await axios.get(route('admin.whatsapp.qr'));
...
<template>
    <AppLayout>
        ...
        <div class="mb-6">
            <h2 class="text-2xl font-bold text-gray-900">WhatsApp Sistem</h2>
            <p class="text-gray-500 mt-1">Hubungkan nomor WhatsApp untuk mengirim notifikasi otomatis.</p>
        </div>
