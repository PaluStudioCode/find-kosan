...
const submit = () => {
    if (isEditing.value) {
        form.put(route('superadmin.facilities.update', editingId.value), {
            onSuccess: () => {
                isModalOpen.value = false;
            },
        });
    } else {
        form.post(route('superadmin.facilities.store'), {
            onSuccess: () => {
                isModalOpen.value = false;
            },
        });
...
const handleFilter = (e) => {
    router.get(route('superadmin.facilities.index'), { type: e.target.value }, { preserveState: true });
};
</script>
